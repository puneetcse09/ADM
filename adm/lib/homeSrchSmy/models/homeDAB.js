...
module.exports.getHomeSearchResults = function(loggedInUser, res) {
//	var schoolId=loggedInUser.schoolDetails.schoolId;
	var queryAllUsersCount= "MATCH (n:School) RETURN n";
	console.log("getHomeSearchResults",queryAllUsersCount);
