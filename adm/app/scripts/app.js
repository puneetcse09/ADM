...
var educationMediaApp=angular.module('educationMediaApp', ['ui.router','SpinnerApp','DirectiveUtil','ui.calendar','infinite-scroll','ui.bootstrap',
    'ui.bootstrap.datetimepicker','smart-table','ngReactGrid', 'xeditable'])
    .run(
